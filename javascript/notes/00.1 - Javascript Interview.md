...
- Function combined with its outter scope forms clouse.
...
- If we nest, multiple callback function then it from pyramid like structure, called callbackhell.
- Reduce readability and maintainability of the code.

<img src="callback-hell.png">
...
|Cookies are the most well-known and oldest (**HTML4-based**) method.|HTML5 has a brand-new feature called **"Session Storage".**|HTML5 has a brand-new feature called **"Session Storage".**|
